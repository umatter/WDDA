...
# Hinweis: Dieses Beispiel benötigt einen Datensatz 'Inventory', der in diesem Beispiel nicht verfügbar ist
# Hier ist ein Beispiel, wie das Recoding funktionieren würde:
...
# Hinweis: Dieses Beispiel benötigt einen Datensatz 'Stereo', der in diesem Beispiel nicht verfügbar ist
# Hier ist ein Beispiel, wie ein Streudiagramm erstellt werden würde:
