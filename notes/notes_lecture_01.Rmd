...
1. **Klassische (verschachtelte) Syntax**: Funktionen werden von innen nach außen gelesen
...
mean(sqrt(abs(x)))  # Lese von innen nach außen: erst abs(), dann sqrt(), dann mean()
