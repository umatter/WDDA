...
- Als Galton jedoch den Median ``the middle-most estimate'' aller Schätzungen berechnete, war dieser bemerkenswert nahe am tatsächlichen Gewicht
...
cat("Median der Schätzungen:", round(median(sample_guesses)), "kg\n")
cat("Wahres Gewicht:", true_weight, "kg\n")
cat("Fehler des Medians:", round(median(sample_guesses) - true_weight), "kg\n")
```
