...
\item Als Galton jedoch den Median ``the middle-most estimate'' aller Schätzungen berechnete, war dieser bemerkenswert nahe am tatsächlichen Gewicht
\item Galton veröffentlichte seine Ergebnisse 1907 in der Zeitschrift Nature in einem Artikel mit dem Titel "Vox Populi" (Die Stimme des Volkes)
\end{itemize}
\end{column}
\begin{column}{0.4\textwidth}
```{r, echo=FALSE, out.width="100%", fig.align="center"}
