...
# Verwende das lokale Bild aus dem img-Ordner mit absolutem Pfad
img_path <- file.path(getwd(), "..", "img", "galton.jpg")
if(file.exists(img_path)) {
  knitr::include_graphics(img_path)
} else {
  # Fallback: Versuche einen relativen Pfad
  img_path2 <- "img/galton.jpg"
  if(file.exists(img_path2)) {
    knitr::include_graphics(img_path2)
  } else {
    cat("Bild konnte nicht gefunden werden. Bitte überprüfen Sie den Pfad.")
  }
}
```
