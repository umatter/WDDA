...
Dieses Dokument fasst alle R-Code-Beispiele der Folien aus der WDDA FS2026 Vorlesung 6 (Kapitel 6) zusammen. Der Fokus liegt auf der multiplen linearen Regression, einer Erweiterung der einfachen linearen Regression auf mehrere Prädiktoren.
...
# Untersuchung der erklärenden Variablen
...
# Multiple lineare Regression (TV und Radio)
...
# Regressionsfläche (Plane of Best Fit)
...
# Modellgüte und Erklärungskraft
...
# Erweiterung: Multiple Regression mit drei Prädiktoren
...
# Nichtlineare Modelle: Quadratische und polynomiale Regression
