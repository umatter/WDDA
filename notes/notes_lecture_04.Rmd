...
```{r stichprobengroesse, eval=TRUE}
...
text(p_hat, 0.1, "Punktschätzung: 42%", col = "blue")
text(mean(plausible_interval), -0.1, "95%-Konfidenzintervall: [39.2%, 44.8%]", col = "blue")
arrows(p_hat, 0.08, p_hat, 0, col = "blue", angle = 20, length = 0.1)
arrows(mean(plausible_interval), -0.08, plausible_interval[1], 0, col = "blue", angle = 20, length = 0.1)
arrows(mean(plausible_interval), -0.08, plausible_interval[2], 0, col = "blue", angle = 20, length = 0.1)
```
