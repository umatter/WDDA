...
Dieses Dokument fasst alle R-Code-Beispiele der Folien aus der WDDA FS2026 Vorlesung 5 (Kapitel 5) zusammen. Der Fokus liegt auf der einfachen linearen Regression, einem grundlegenden statistischen Verfahren zur Modellierung des Zusammenhangs zwischen zwei Variablen.
...
# Abweichungen vom Modell: Quantifizierung
...
- In diesem Beispiel hat Linie 1 (y = 7 + 0.04x) eine kleinere RSS als Linie 2 (y = 5 + 0.07x), was darauf hindeutet, dass sie besser zu den Daten passt.
...
legend("bottomright",
       legend = c(sprintf("Händisch: y = %.4f + %.4fx", b0, b1),
