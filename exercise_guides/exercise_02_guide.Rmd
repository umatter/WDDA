...
3. **Balkendiagramme erstellen:**  
   ...
   barplot(gender_freq,
   main = "Verteilung von Gender", col = "lightblue", ylab = "Häufigkeit")
...
1. **Daten laden und Histogramm für `fruit` erstellen:**  
   ...
   # Convert fruit to numeric if it's not already
   fruit_numeric <- as.numeric(data$fruit)
   hist(fruit_numeric, main = "Histogramm von Fruit", xlab = "Fruit", col = "lightblue")
   ```
