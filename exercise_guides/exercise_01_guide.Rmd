...
- **Metrische/Quantitative Variablen**: Numerische Messungen, die sein können:
  - **Diskret**: Zählbare Werte (z.B. Anzahl der Kinder)
...
**Klassifikation**: Metrisch und diskret
...
**Klassifikation**: Metrisch und stetig
...
**Klassifikation**: Nominal und diskret
...
**Klassifikation**: Ordinal und diskret
